   ...
   public partial class OneSignalImplementation : OneSignalSDK {
      ...
      public override LogType LogLevel {
         ...
         set {
            ...
            OneSignalNative.SetLogLevel((OneSignaliOS.OneSLogLevel)currentLogLevel, (OneSignaliOS.OneSLogLevel)currentAlertLevel);
         }
      }
      ...
      public override void ClearOneSignalNotifications() {
         Console.WriteLine("OneSignal: Android only function");
      }

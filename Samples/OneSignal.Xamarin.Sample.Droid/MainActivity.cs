...
using Android.OS;
using OneSignal.Xamarin.Sample.Shared;
using System;

namespace OneSignal.Xamarin.Sample.Droid
{
   [Activity(Label = "OneSignal.Xamarin.Sample.Droid", MainLauncher = true, Icon = "@mipmap/icon")]

...
namespace Com.OneSignal.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal']/class[@name='PushRegistratorGPS']"
	[global::Android.Runtime.Register ("com/onesignal/PushRegistratorGPS", DoNotGenerateAcw=true)]
	public partial class PushRegistratorGPS : global::Java.Lang.Object, global::Com.OneSignal.Android.IPushRegistrator {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/onesignal/PushRegistratorGPS", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PushRegistratorGPS); }
		}

		protected PushRegistratorGPS (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal']/class[@name='PushRegistratorGPS']/constructor[@name='PushRegistratorGPS' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushRegistratorGPS ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (PushRegistratorGPS)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.OneSignal.Android.PushRegistratorGPS __this = global::Java.Lang.Object.GetObject<global::Com.OneSignal.Android.PushRegistratorGPS> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/class[@name='PushRegistratorGPS']/method[@name='registerForPush' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='com.onesignal.PushRegistrator.RegisteredHandler']]"
